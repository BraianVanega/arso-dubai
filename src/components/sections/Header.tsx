    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-outline bg-surface shadow-sm">
      ...
      >
        <Container className="flex flex-col gap-1 py-4">
          ...
          <a
            href="#contact"
            className="mt-2 inline-flex min-h-10 items-center justify-center rounded-sm bg-primary px-5 py-2.5 text-center text-sm font-semibold text-white hover:bg-primary-hover"
            onClick={() => setOpen(false)}
          >
            {header.cta}
          </a>
