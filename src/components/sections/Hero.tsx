...
import { BarChart3, Building2, FileCheck, Globe } from "lucide-react";
...
export function Hero() {
  ...
  return (
    <section id="home" className="scroll-mt-16 border-b border-outline pt-16">
          ...
          <Card as="aside" className="overflow-hidden rounded-lg">
            <div className="relative aspect-video bg-surface-container">
              <Image
                ...
                alt="Institutional image of ARSOPA Solutions S.A. (placeholder)"
                fill
                priority
                unoptimized
