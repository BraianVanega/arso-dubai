  ...
  return (
    ...
    >
      <Container>
        ...
        <p className="mx-auto mt-8 max-w-3xl rounded-md border border-secondary/30 bg-secondary-light px-4 py-3 text-center text-sm leading-6 text-secondary shadow-sm">
          {services.scopeNote}
        </p>
      </Container>
    </section>
